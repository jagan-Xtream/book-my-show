    ...
    return (
      <React.Fragment>
        ...
        <div
          ...
          style={{
            transform: this.props.showAbout
              ? "translateY(0)"
              : "translateY(100vh)",
        ...
        >
          ...
          <div className={classes.AboutText}>
            <p>
              This is a MERN stack single page application created with full
              CRUD functionality.
            </p>
            <p>
              With this application, seat tickets can be selected from a grid
              and purchased.
            </p>
