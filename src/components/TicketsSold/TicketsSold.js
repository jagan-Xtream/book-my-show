...
class ticketsSold extends Component {
  shouldComponentUpdate(nextProps) {
    return (
      nextProps.showTicketsSold ||
      nextProps.showTicketsSold !== this.props.showTicketsSold
    );
  }
  ...
  render() {
    ...
    if (
      this.props.selectedMovie.orders &&
      this.props.selectedMovie.orders.length > 0
    ) {
    ...
    return (
      <React.Fragment>
        ...
        <div
          ...
          style={{
            transform: this.props.showTicketsSold
              ? "translateY(0)"
              : "translateY(100vh)",
